...
SevenPP_Image = pygame.image.load('D:\Python Programming\Project\Images\sevenppack.png').convert_alpha()
SevenPP_Rect= SevenPP_Image.get_rect()
SevenPP_Rect.center = (965,300)
transparent = pygame.image.load('D:\Python Programming\Project\Images\def.png').convert_alpha()
###########
